            ...
            items: [{
                ...
                listeners: {
                    ...
                    itemclick: function (view, record, item) {
                        ...
                        if (record.data.leaf) {
                            //如果没有与当前点击项目id相同的的标签页的话
                            if (record.data.text == "项目员工信息管理") {
                                $('#cenIF').attr("src", "xmygxxgl.action");
                            }
                        }
                    }
                }
                                    ...
                                    dblclick: {
                                        ...
                                        fn: function () {
                                            ...
                                            if (selectedI.selected.items && selectedI.selected.items.length > 0) {
                                                ...
                                                Ext.MessageBox.confirm("提示", "确定要重置？", goReset);
