...
<body>
	<!--百度地图容器-->
	<div style="width: 1366px; height: 700px; border: #ccc solid 1px;"
		id="dituContent"></div>
</body>
<script type="text/javascript">
	//创建和初始化地图函数：
	...
	function createMap() {
		...
		var point = new BMap.Point(90, 120);//定义一个中心点坐标
	...
	var plPoints = [ {
		...
		color : "#00f",
		opacity : 0.6,
		points : [ "116.424391|39.916263", "116.318606|39.91405",
				"116.315732|39.951229", "116.312857|39.975562",
				"116.306533|39.987503" ]
	} ];
	//向地图中添加线函数
